...
Clash Verge Rev 全局扩展脚本：只把 Claude、ChatGPT、Gemini、Antigravity、Cursor、Grok Build 的核心 AI 流量送进住宅 SOCKS5 链路。额外小站由 extra 分类按需打开。插件市场、下载、YouTube 和其他非 AI 流量仍走原 Profile。
